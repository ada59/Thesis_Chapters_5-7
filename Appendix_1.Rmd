...
g1<-g1+labs(title="Surveyed locations in Central Mexico")
...
ggsave(MexicoMap, file= paste0(plot_dir, "/SM/MexicoMap.jpg"), width = 14, height = 8)
ggsave(EIMap, file= paste0(plot_dir, "/SM/EIMap.jpg"), width = 14, height = 8)
...
ggsave(SpecaccumP, file=paste0(plot_dir, "/SM/SpecaccumP.jpg"), width=8, height=8)
```
<p>&nbsp;</p>
...
write.csv2(round(listSpecpool,2), file=paste0(plot_dir, "/SM/listSpecpool.csv"), row.names = F)
